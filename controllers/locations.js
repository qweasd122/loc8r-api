...
const renderHomepage = (req, res, responseBody) => {
    ...
    res.render('locations-list', {
        ...
        sidebar: "Looking for wifi and a seat? Loc8r helps you find places \
         ...
         Let Loc8r help you find the palce you're looking for.",
...
const renderDetailPage = (req, res, location) => {
    res.render('location-info', {
        title: '2020810012 김승권',
        pageHeader: {
            title: location.name
        },
        sidebar: {
            context: 'is on Loc8r because it has accessible wifi and \
             space to sit down with your laptop and get som work done.',
...
const getLoationInfo = (req, res, callback) => {
...
const renderReviewForm = function (req, res, {name}) {
    res.render('location-review-form', {
        ...
        pageHeader: { title: `2020810012 김승권 Review ${name}` },
        error: req.query.err
    });
}
